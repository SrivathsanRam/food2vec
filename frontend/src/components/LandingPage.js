...
const LandingPage = () => {
    ...
    return (
        <div className="landing-page">
            ...
            >
                {/* Profile Button - Left */}
                <IconButton onClick={handleProfileClick} size="small" sx={{ border: "1px solid #e0e0e0" }}>
            ...
            {hasSearched && !isLoading && <SearchResults results={searchResults} />}

            <SliderComponent kValue={kValue} setKValue={setKValue} />

            <Button variant="contained" onClick={handleModalOpen} sx={{ mt: 4, mb: 4 }}>
            ...
            <Modal open={isModalOpen} onClose={handleModalClose}>
                <Box sx={style}>
                    <Box sx={modalHeaderStyle}>
                        ...
                        <IconButton onClick={handleModalClose} sx={closeButtonStyle} disabled={isCreating}>
                            <CloseIcon />
                        </IconButton>
                    </Box>
                    <Box sx={modalContentStyle}>
                        ...
                        <TextField
                            ...
                            disabled={isCreating}
                        />
                        {createStatus === "success" && <Alert severity="success">Recipe created successfully!</Alert>}
                        {createStatus === "error" && <Alert severity="error">Failed to create recipe.</Alert>}
                    </Box>
